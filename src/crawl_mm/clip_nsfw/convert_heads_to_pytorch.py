...
from crawl_mm.clip_nsfw.models import NSFWModel_B32, NSFWModel_L14
...
model_keras = load_model(
    os.path.splitext(b32_path)[0], custom_objects=ak.CUSTOM_OBJECTS
)
...
print(
    "ViT-B32 | Difference between keras and torch models is :",
    model_out_pytorch - model_out_keras,
)

# Save the model
torch.save(
    model_pytorch.state_dict(), "./models/clip_ViT-B-32_openai_binary_nsfw_head.pth"
)
...
# Keras Model
model_keras = load_model(
    os.path.splitext(l14_path)[0], custom_objects=ak.CUSTOM_OBJECTS
)
model_out_keras = model_keras.predict(embed)
...
# Print the difference
print(
    "ViT-L14 | Difference between keras and torch models is :",
    model_out_pytorch - model_out_keras,
)

# Save the model
torch.save(
    model_pytorch.state_dict(), "./models/clip_ViT-L-14_openai_binary_nsfw_head.pth"
)
